...
Source acquisition is in the branch's four bounded GitHub Actions workflows. Poly Haven sources and Khronos ToyCar are CC0; original byte checksums and transformed outputs are recorded separately. Runtime acquisition checks the official Blender checksum. No API credentials are used.
